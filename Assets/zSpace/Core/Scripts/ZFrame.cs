...
namespace zSpace.Core
{
    ...
    public sealed partial class ZFrame : MonoBehaviour
    {
        ...
        public Vector3 WorldPosition
        {
            get
            {
                if (this._displayAligner != null)
                {
                    return this._displayAligner.transform.position;
                }
                else
                {
        ...
        public Quaternion WorldRotation
        {
            get
            {
                if (this._displayAligner != null)
                {
                    return this._displayAligner.transform.rotation;
                }
                else
                {
        ...
        /// </summary>
        public ZDisplayAligner DisplayAligner
        {
            get
            {
                return this._displayAligner;
            }
        }

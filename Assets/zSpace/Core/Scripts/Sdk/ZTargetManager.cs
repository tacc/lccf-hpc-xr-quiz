...
namespace zSpace.Core.Sdk
{
    public class ZTargetManager : ZNativeResourceCache<ZTarget>
    {
        ...
        /// </summary>
        public ZTarget HeadTarget
        {
            get
            {
                return this.GetTarget(ZTargetType.Head);
            }
        }
        ...
        /// </summary>
        public ZTarget LeftEyeTarget
        {
            get
            {
                return this.GetTarget(ZTargetType.LeftEye);
            }
        }
        ...
        /// </summary>
        public ZTarget RightEyeTarget
        {
            get
            {
                return this.GetTarget(ZTargetType.RightEye);
            }
        }
        ...
        /// </summary>
        public ZTarget CenterEyeTarget
        {
            get
            {
                return this.GetTarget(ZTargetType.CenterEye);
            }
        }
        ...
        /// </summary>
        public ZTarget StylusTarget
        {
            get
            {
                return this.GetTarget(ZTargetType.Primary);
            }
        }

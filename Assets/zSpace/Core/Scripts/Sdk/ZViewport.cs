...
namespace zSpace.Core.Sdk
{
    ...
    {
        public ZViewport(IntPtr nativePtr, bool isNativePtrOwner = true)
            : base(nativePtr)
        {
            this._isNativePtrOwner = isNativePtrOwner;
        ...
        /// </summary>
        public ZFrustum Frustum { get; private set; }
        ...
        private bool _isNativePtrOwner = true;
    }
}

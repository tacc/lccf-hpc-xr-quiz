...
namespace zSpace.Core.Sdk
{
    public class ZFrustum : ZNativeResource
    {
        ...
        /// <summary>
        /// Computes the default eye pose for most optimal 
        /// viewing perspective.
        /// </summary>
        public Pose DefaultEyePose
        {
            get
            {
        ...
        /// <summary>
        /// Sets the left and right eye poses in tracker space.
        /// </summary>
        /// 
        ...
        /// </param>
        public void SetTrackerSpaceEyePoses(
            Pose leftEyePose, Pose rightEyePose)
        {
            ZPlugin.LogOnError(
                ZPlugin.SetFrustumTrackerSpaceEyePoses(
                    this._nativePtr,
                    leftEyePose.ToZPose(),
                    rightEyePose.ToZPose()),
                "SetFrustumTrackerSpaceEyePoses");
        }

        /// <summary>
        /// Gets the current left and right eye poses in tracker space.
        /// </summary>
        /// 
        /// <param name="leftEyePose">
        ...
        /// </param>
        public void GetTrackerSpaceEyePoses(
            out Pose leftEyePose, out Pose rightEyePose)
        {
            ZPose internalLeftEyePose;
            ZPose internalRightEyePose;
            ZPlugin.LogOnError(
                ZPlugin.GetFrustumTrackerSpaceEyePoses(
                    this._nativePtr,
                    out internalLeftEyePose,
                    out internalRightEyePose),
                "GetFrustumTrackerSpaceEyePoses");

            leftEyePose = internalLeftEyePose.ToPose();
            rightEyePose = internalRightEyePose.ToPose();
        }
